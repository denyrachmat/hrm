...
@section('title', __('Detail of Bank'))
        ...
        <div class="page-title">
            <div class="row">
                ...
                <x-breadcrumb>
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('banks.index') }}">{{ __('Bank') }}</a>
                    </li>
                                ...
                                <table class="table table-hover table-striped">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <img src="{{ asset('storage/uploads/logos/' . $bank->logo) }}" alt="Image" class="rounded" width="200" height="150" style="object-fit: cover">
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
